...
public class MoreDetails1 extends JFrame {
    ...
    public MoreDetails1() {
        ...
        // Create image
        JLabel movieImage = createImage("image2.jpg");
        ...
        getTicketButton1.setBackground(new Color(41, 1, 51));
        getTicketButton1.setForeground(Color.WHITE);
        getTicketButton2.setBackground(new Color(41, 1, 51));
        getTicketButton2.setForeground(Color.WHITE);
        getTicketButton3.setBackground(new Color(41, 1, 51));
        getTicketButton3.setForeground(Color.WHITE);
        ...
        backButtonPanel.setBackground(new Color(192, 178, 143)); // Set background color
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(MoreDetails1::new);
    }
}
